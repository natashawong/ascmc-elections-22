...
export const president_candidate_data = [
...

    {
      ...
      name: 'Jon Joey Telebrico (President)',
...
export const evp_candidate_data = [
    {
      imageSource: zane,
      name: 'Zane Yamamoto (EVP)',
      candidateDescription: ['Hey CMC!', 'My name is Zane Yamamoto and I\’m running to be your Executive Vice President! I was born and raised in Honolulu, Hawaii and I\’m currently the Sophomore Class President. Last year, I served as a senator on the AAA committee after a less-than-successful run for first-year class president. I have built working relationships within ASCMC and an intimate knowledge of how to navigate the bureaucracy of the Senate and Executive Board in order to get things done.', 'As EVP, I will work to bring more people to the Senate and have the agenda reflect the everyday concerns of students. Modeling both the legendary Cindy Lay and Sam Harrison, Senate will feature Deep Dives into campus issues, senator-led initiatives, and Town Halls with important guests. The Senate should be at the forefront of tackling challenges facing CMC students, especially marginalized students.', 'A CMC that isn’t right for some of us is a CMC that doesn’t work for all of us.', '', 'I\’m running to unlock the potential of ASCMC even if it doesn\’t always play out in practice.', 'I\’m running because a 400K budget can produce tangible impact.', 'I’m running for an ASCMC that works.','','I’m running to: ', 'Define our “New Normal.” ASCMC should proactively work with the administration to define the ‘new normal’ for campus. The Senate should elevate student voices in this discussion and make admin decisions transparent.', 'Focus on Students. (and Services!) We should concentrate on how ASCMC can meet the needs and concerns of students. The Senate should serve as a conduit for identifying those needs and creating solutions.', 'Transform ASCMC. The “Corporation” needs more than facelifts or floor speeches. I will continue the work of the Organizational Review Committee in examining, analyzing, and solving ASCMC’s problems.', 'Aloha & Live Long and Prosper','-Zane #VoteZ4EVP'],
    },
...
export const dac_candidate_data = [
  {
    ...
    name: 'Kirby Kimball (DAC)',
    candidateDescription: ['As the 2022-2023 ASCMC Dormitory Affairs Chair (DAC), I aim to translate campus desires and frustrations to the administrative world of CMC: a connection that is much needed after our return to campus post-pandemic lockdown. I have the requisite leadership skills and work-ethic to take social life – its successes and failures – and institute concrete change. Celebration and support must return after the incredibly taxing two years we’ve experienced as young adults. As Community Service Interim Chair for ASCMC during my freshman fall term, my goal was to tackle local and national needs by engaging the CMC student body. From experiential service trips with local NPOs to social fundraising events, my time serving ASCMC and the greater Pomona Valley community has made a mark. I would be grateful to continue this impact in an Executive Board position as your DAC. Highly involved in multiple facets of the CMC community, I have made impactful social connections with students of many interest groups. My desire to be your DAC stems from the conversations I’ve had with these diverse groups of students: there is a lack of community across quads/dorms and there needs to be more administrative support to our CMCers, especially after the world-altering effects of the pandemic. Free bonding adventures with intersecting quads, mandatory supply of menstrual products, dorm service trips, mental health support and general SHS improvement, and regular cultural celebrations are all ideas I plan to make a reality, ideas I’ve gathered from you: my peers. In an effort to remain accessible and open to change, I will host weekly office hours and work on-call with DOS/RAs to address pressing campus-life problems. Fixing road bumps along the way, as DAC I’ll ensure that you’ll recall the 2022-2023 CMC term 40 years from now as truly “the good life”.'],
  },
]
...
export const senior_candidate_data = [
...

    {
      ...
      name: 'Sophie Dvorkin (2023 President)',
...

    {
      ...
      name: 'Amari Huang (2023 President)',
...
export const sophomore_candidate_data = [
    {
      imageSource: gio,
      name: 'Giovanni Pierre (2025 President)',
      candidateDescription: ['Hey CMC class of 2025!', 'My name is Gio Pierre (he/him) and I’m running to be your second-year class president. In my conversations with you all, one subject is consistently brought up: a lack of community among our class. Some of you are feeling isolated and are having trouble finding your people at CMC. I’m here to fix that. While I work behind the scenes on critical issues like divestment as well as diversity and inclusion, my overarching focus will be centered around community building.', 'We need to make the class of 2025 feel like one big family. I will plan a field day that’s just for us so we can have fun and get to know each other better. I’ll also meet with the 2025 class presidents from the other Claremont Colleges to plan a 5C class of 2025 party next year. I’ll send out weekly emails complete with helpful tips for self-care and academics, advertisements for smaller events that I’ll be hosting, and very corny jokes (my specialty). I’ll also be doing polls, Q&As, and suggestion boxes on Instagram because I value your input. I’ll be a smiling face around campus you can always come up to if you need someone to talk to or if you just want to hang out. I want you all to feel supported. Since parties aren’t for everyone, I’ll plan class mic nights, barbeques, and beach trips along with other non-party events. My cabinet will be a diverse group that will advise me on how best to advocate for all members of our class.', 'This past year, our class broke a CMC record with 81% voter turnout. Let’s break our own record and G.O. Vote 4 Gio on election day, Tuesday, March 1!', 'Peace and love <3', 'Gio', ' '],
    },
